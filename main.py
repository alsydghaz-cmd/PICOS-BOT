...
ADMIN_UID = "14743481406"  # Your admin UID
server2 = "ME"
key2 = "MAHFUJ"
                        ...
                        if inPuTMsG.startswith('/join'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    if can_send_emote_to(sender_uid) and can_send_emote_to(14743481406):
...
async def MaiiiinE():
    Uid, Pw = '4518017169', '55BB179A4885F1539B1511ADF43E1AA7A63816CB0FAD0AF79E5AA3317523302D'
